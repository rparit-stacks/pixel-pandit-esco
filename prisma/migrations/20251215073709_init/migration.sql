-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'ESCORT', 'CLIENT');
...
-- CreateIndex
CREATE UNIQUE INDEX "Listing_profileId_key" ON "Listing"("profileId");
...
-- AddForeignKey
ALTER TABLE "Booking" ADD CONSTRAINT "Booking_escortProfileId_fkey" FOREIGN KEY ("escortProfileId") REFERENCES "Profile"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_escortProfileId_fkey" FOREIGN KEY ("escortProfileId") REFERENCES "Profile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
